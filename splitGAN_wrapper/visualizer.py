...
import ntpath
import time
from . import utilities, html_create
...
def save_images(webpage, visuals, image_path, aspect_ratio=1.0, width=256, use_wandb=False):
    ...
    Parameters:
        webpage (the HTML class) -- the HTML webpage class that stores these imaegs (see html_create.py for more details)
...
class Visualizer():
    ...
    def __init__(self, opt):
        ...
        if self.use_html:  # create an HTML object at <checkpoints_dir>/web/; images will be saved under <checkpoints_dir>/web/images/
            ...
            utilities.mkdirs([self.web_dir, self.img_dir])
